...
wallet_total = {"USDT": 100, "USDC": 100, "BTC":.0002}
risk_percentage = .005
...
def detect_arbitrage_opportunity(pair):
    try:
        ...
        if profit_percentage > .1:  # Arbitrage opportunity threshold
...
while run:
    ...
    # Save the stored order book data with timestamps as a JSON file
    ...
    print("Sleeping for 60 seconds to give the market time to move.")
    time.sleep(60)
